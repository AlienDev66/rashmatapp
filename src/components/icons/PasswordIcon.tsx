...
export function PasswordIcon({ size = 20, color = "#FFFFFF", ...props }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
      ...
      />
      <Path d="M12 13L12 17" stroke={color} strokeWidth={2} strokeLinejoin="round" />
      <Path
        d="M9 9V5.32456C9 4.53354 9.50616 3.83128 10.2566 3.58114C11.3883 3.20392 12.6117 3.20392 13.7434 3.58114C14.4938 3.83128 15 4.53354 15 5.32456V9"
        stroke={color}
        strokeWidth={2}
        strokeLinejoin="round"
      />
